...
*   **[CoronaNet General RA Meeting](https://nyu.zoom.us/j/58230804): **In the general RA meeting that we have every Wednesday at 4:30pm CET, the PIs share updates about the progress of the project. Recordings of older meetings can be found at the end of this section. 
...
*   The FAQ tab in the **[Shiny App](https://kubinec.shinyapps.io/corona_validate/)** : The FAQ tab summarizes and organizes common questions asked in the #ra-chat channel
...
5. Look through the RA FAQs in the**[ Shiny App](https://kubinec.shinyapps.io/corona_validate/)** for commonly asked questions
...
![](img/Codebook/1. What counts as a policy.png)
...
Please post the entry that you need to be deleted in the #orphaned-records channel.
...
![](img/Codebook/2. data cleaning slack.png){width=30%}
...
![](img/Codebook/3. Data cleaning trello.png){width=70%}
...
![](img/Codebook/4. Data cleaning download dataset.png){width=70%}
...
![](img/Codebook/5. Data cleaning finilize a cleaning task.png){width=70%}
...
![](img/Codebook/6. Validation look for observation.png){width=50%} 
...
![](img/Codebook/7. Validation click on source.png){width=50%} 
...
# CoronaNet Policy Completeness Check
...
Ever since we began this project, hundreds of research assistants have helped us in collecting policy information. While everyone has put a huge effort in systematically collecting all policies for all countries, we are aware that some policies might have gone undetected by our talented RAs. 
 ...
 \
To ensure the completeness of our dataset, we request policy-based completeness checkers to compare our dataset with other datasets and check whether their information fully matches with our released dataset. We compare our dataset with the following datasets: 



1. [ACAPS COVID-19: Government Measures Dataset](https://www.acaps.org/covid19-government-measures-dataset) 
...
3. [OECD Country Policy Tracker](https://www.oecd.org/coronavirus/country-policy-tracker/)
4. [WHO PHSM Dataset](https://www.who.int/emergencies/diseases/novel-coronavirus-2019/phsm)

As you will see, policy types are coarser and the country coverage is more limited in the other datasets compared to our dataset. Therefore, we provide an overview of the different policy categories and how they can be assigned to the CoronaNet policy categories. This is helpful for the identification of policies that are compared. 
...
9.  Once you are done with an entire policy-region, contact the responsible Regional Manager and report all the incompleteness that you have detected. If you have not detected any incompleteness, please let the Regional Manager know that you have successfully checked the completeness for a policy in the region. You can identify the responsible regional manager [here](https://docs.google.com/spreadsheets/d/1gNvxWSrAdrM2aj7JyQKlAdQNdBkl7kDMOdJWSZBjvj0/edit?pli=1#gid=0). \
...
![](img/Codebook/8. Slack chennels.png)
</center>
...
![](img/Codebook/9. Slack threads.png)

</center>

_<span style="text-decoration:underline;">Direct Messages</span>_

|   Perhaps you need to contact somebody within the project personally, but there is no need for a specific channel, utilise the direct message 
|   function instead.
|       
<center>

![](img/Codebook/10. slack direct messages.png)
...
![](img/Codebook/11. Slack notifications mute.png)
...
![](img/Codebook/13. Slack pinned items.png)
</center>
...
![](img/Codebook/14. Slack online away.png)
</center>
...
**Check the “pinned items”** for some useful information for all RA’s. You can also utilise the FAQ tab in the [Shiny App](https://kubinec.shinyapps.io/corona_validate/), which is updated based on the questions you ask in this channel. 
...
![](img/Codebook/15. CoronaNet worspace pinned items.png){width=30%}
...
![](img/Codebook/16. CoronaNet workspace examped pinned.png){width=20%}
</center>
**# random**
...
1. Select the Country and/or City/Province of the records you are trying to locate (one or more Countries can be selected simultaneously) 

<center>

![](img/Codebook/17. Shiny select country.png){width=70%}
</center>
...
![](img/Codebook/18. Shiny policy catergory.png){width=70%}
...
![](img/Codebook/19. Shiny Policy records table (1).png){width=70%}


![](img/Codebook/19. Shiny Policy records table (2).png){width=70%}
...
![](img/Codebook/20. Shiny timeline visualization.png){width=70%}
...
![](img/Codebook/21. Shiny if user then clicks on the policy records table....png){width=70%}

</center>

  *   Utilise the ‘Clear records selected’ button to clear this filter and repeat the process from the beginning 

**Link to the [app](https://kubinec.shinyapps.io/corona_validate/).**
...
![](img/Codebook/22. Organisational flow chart.png)
...
You can see which house RAs have been allocated to on this sheet:
[https://docs.google.com/spreadsheets/d/1qxkKu7gOdt2I0JjgJmviD6EpKdJoP9gU1p5cjOqgONk/edit#gid=0](https://docs.google.com/spreadsheets/d/1qxkKu7gOdt2I0JjgJmviD6EpKdJoP9gU1p5cjOqgONk/edit#gid=0). 
...
*   RA FAQ in the **[Shiny App](https://kubinec.shinyapps.io/corona_validate/)** 
...
![](img/Codebook/23. Application for research position.png){width=50%}
...
![](img/Codebook/24. RA Onboarding mail sub folder done.png){width=50%}
...
|       Dear XYZ, 
|   
|       We appreciate your interest to join the CoronaNet Research Group. In these exceptional times it is important to gather data for real-time 
|       research. In order to apply and to become a member of the team, please fill out the following form: [https://form.jotform.com/201172569499062](https://form.jotform.com/201172569499062)
|   
...
![](img/Codebook/25. RA Onboarding eval 1 eval 2.png){width=60%}
</center>
...
|
|
|       Your will be involved in the data collection process. The work mainly involves sifting through news reports to identify different policies that     
|       government have enacted to combat COVID-19. You will each be assigned one unique country if you choose to participate.  If chosen, you will 
|       be responsible for (1) researching what government policies your country has implemented starting from the beginning of the epidemic and (2) 
|       keeping up to date with new government policy actions on a daily basis.
|
...
*   After you passed the training, you will be allocated a country, receive the link to the main survey and will be added to Slack.
|       
|       

|       We hope that our project will increase the public's awareness and understanding of what policies governments around the world are taking in 
|       response to the virus. Thank you for joining this journey!
|       
|       
|       All the best, 
|       
...
|       Dear XYZ, 
|       
|       We appreciate your interest and application at CoronaNet. We are sorry to tell you that we have decided not to invite you to become a research 
|       assistant for our team. This does not mean that you won´t be able to use the data (which you can download here: [www.coronanet-project.org](http://www.coronanet-project.org)) 
...
![](img/Codebook/26. RA Onboarding add to slack.png)
</center>
...
![](img/Codebook/27. date in month-day form.png){width=50%}
