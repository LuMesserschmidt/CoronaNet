...
The CoronaNet Database provides fine-grained, dyadic data on policy actions taken by governments across the world since the Chinese government reported the COVID-19 outbreak on December 31, 2019. The dataset presented here covers all policy actions for X number of countries up until XX XX, 2020, for a total of YY number of events.
Our data collection efforts are still ongoing. For the most current, up to date version of the dataset, please visit http://coronanet-project.org/download.  
