...
In the plot below you can see scores for the vast majority of countries in the world. If hover over a line in the plot, you can see the country and some details about policies in that country.

::: {#legend_div .greeting .message width="40%"}
