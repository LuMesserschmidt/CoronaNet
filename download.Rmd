...
This [repository](https://github.com/saudiwin/corona_tscs) contains data from the [CoronaNet data collection project](http://coronanet-project.org) and also data and code to fit the model described in "A Retrospective Bayesian Model for Measuring Covariate Effects on Observed COVID-19 Test and Case Counts", [link here](https://osf.io/preprints/socarxiv/jp4wk). 

**Please note that while we make every effort to validate this data, the speed and scale with which it was collected means that we cannot validate all of it. If you find an error in the data, please file an issue on this Github page or fill out this [form](https://forms.gle/2Zc5Rrdq9J43b7NR9).**
...
Files to reproduce the paper "A Retrospective Bayesian Model for Measuring Covariate Effects" Data and Code {-}:
