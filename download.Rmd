...
```{r echo= FALSE, message=FALSE, cache=TRUE, results='asis', out.width='100%'}
release <- "https://raw.githubusercontent.com/saudiwin/corona_tscs/master/data/CoronaNet/coronanet_release.csv"
data_release <- read_csv(release)

dt <- datatable(data_release,
          caption = 'CoronaNet Core Dataset',
...
```{r echo=FALSE, message=FALSE, cache=TRUE, results='asis', out.width='100%'}
allvars <- "https://raw.githubusercontent.com/saudiwin/corona_tscs/master/data/CoronaNet/coronanet_release_allvars.csv"
data_allvars <- read_csv(allvars)

dt <- datatable(data_allvars,
          caption = 'CoronaNet Extended Dataset',
          class = 'cell-border stripe', 
          filter = 'top',
          escape= c(1,2,4,3,5),
          fillContainer = FALSE, 
