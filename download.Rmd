...
Download the Version of the Core Dataset [HERE](https://github.com/saudiwin/corona_tscs/blob/master/data/CoronaNet/coronanet_release.csv)
...
Download the CSV Version of the Extended Dataset [HERE](https://github.com/saudiwin/corona_tscs/blob/master/data/CoronaNet/coronanet_release_allvars.csv)
...
library(readr)
myfile <- "https://raw.githubusercontent.com/saudiwin/corona_tscs/master/data/CoronaNet/coronanet_release.csv"

data <- read_csv(myfile)
library(knitr)
library(readxl)
DT::datatable(data,
          caption = 'CoronaNet Data Release',
