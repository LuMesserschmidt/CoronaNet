...
Download the BETA Version of the Core Dataset [HERE](https://github.com/saudiwin/corona_tscs/blob/master/data/CoronaNet/coronanet_release.csv)
...
Download the CSV BETA Version of the Extended Dataset [HERE](https://github.com/saudiwin/corona_tscs/blob/master/data/CoronaNet/coronanet_release_allvars.csv)
